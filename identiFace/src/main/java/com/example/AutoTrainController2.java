...
public class AutoTrainController2 {
	...
	@ResponseBody
	String uploadingPost(@RequestParam("uploadingFiles") MultipartFile[] uploadingFiles,
			@ModelAttribute("faceId") String faceId) throws Exception {
...
//   System.out.println(path + "檔的大小為：" + g.FormetFileSize(l));
			...
			File file = new File("D:\\eGroupAI_FaceEngine_CPU_V3.1.3_SN\\" + faceId);
			...
			for (int i = 0; i < list.length; i++) {
				...
				// 寫入TXT檔值
				String content1 = "D:\\eGroupAI_FaceEngine_CPU_V3.1.3_SN\\" + faceId + "\\" + list[i] + " " + faceId
						+ "[No]" + count + "\r\n";
